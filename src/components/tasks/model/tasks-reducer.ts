...
import { DomainTask, TaskStatus, TaskPriority } from "@/api/tasksApi.types.ts"
...
export const changeTaskStatusAC = createAction<{ todolistId: string; id: string; status: TaskStatus }>(
  "CHANGE_TASK_STATUS",
)
