import {StyledList, StyledTaskIconButton, TaskTitle} from "@/components/tasks/task/TaskStyles.tsx";
...
import {TaskItem} from "@/components/tasks/task/TaskItem.tsx";
...
export const TaskItems = (props: TaskPropsType) => {
    ...
    return <StyledList>
        {props.tasks.map((t: TaskType) => {
            ...
            return <TaskTitle>
                <TaskItem onChangeTitleHandler={onChangeTitleHandler} onChangeStatusHandler={onChangeStatusHandler}
