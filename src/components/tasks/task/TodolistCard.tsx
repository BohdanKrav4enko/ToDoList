...
import { StyledTextGreetingList } from "./AddTodolistCardStyles.tsx"
...
export const TodolistCard = React.memo((props: TodolistCardProps) => {
  ...
  return (
    <>
      <StyledPaper editMode={editMode} elevation={3} onMouseEnter={editModeHandler} onMouseLeave={editModeHandler}>
        {editMode ? (
          <div>
